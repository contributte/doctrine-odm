...
- [Integrations](#integrations)
  - [`mongodb/mongodb`](#mongodbmongodb)
  - [`doctrine/cache`](#doctrinecache)
...
- Doctrine MongoDB ODM and MongoDB PHP Library, installed by Composer with this package.
...
Register the ODM extension in your NEON configuration:
...
These integrations wire related packages into the Nette DI container.

### `mongodb/mongodb`

Use prepared [nettrine/mongodb](https://github.com/contributte/doctrine-mongodb) integration for the MongoDB PHP Library.
...
This package version uses `doctrine/cache` for ODM metadata cache. Use prepared [nettrine/cache](https://github.com/contributte/doctrine-cache) integration to wire the cache driver in Nette.
...
If you register `nettrine/cache`, the ODM cache extension can use the configured cache driver automatically.
...
Use prepared [contributte/console](https://github.com/contributte/console) integration to register Doctrine ODM commands.
...
After that, `bin/console` contains Doctrine ODM commands.
